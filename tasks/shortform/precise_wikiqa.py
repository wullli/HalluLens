...
class PreciseQAEval:
    def __init__(self, model_path, TASKNAME):
        ...
        self.abtention_evaluator = 'gpt-4o-mini'
        self.halu_evaluator = 'gpt-4o-mini'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inference_method', type=str, default='openai', help='check and customize util/lm.py')
